...
public sealed class PoisonedModifier(PlayerControl poisoner) : TimedModifier
{
    ...
    public override bool HideOnUi => !OptionGroupSingleton<PoisonerRoleOptions>.Instance.AlertOfPoison;

    public override string GetDescription()
    {
        return $"You have been poisoned!\n<b>Time until death: {TimeRemaining:F1}s</b>";
    }
    ...
    public override void OnActivate()
    {
        ...
        if (OptionGroupSingleton<PoisonerRoleOptions>.Instance.AlertOfPoison)
        {
